...
module ipselector_mm_interconnect_0_router_default_decode
  #(
...
module ipselector_mm_interconnect_0_router
(
    // -------------------
    // Clock & Reset
    // -------------------
    ...
    localparam PAD4 = log2ceil(64'h21024 - 64'h21020); 
    ...
    ipselector_mm_interconnect_0_router_default_decode the_default_decode(
